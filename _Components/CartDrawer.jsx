                            ...
                            <div key={item.cartItemId} className="flex gap-4 group">
                                ...
                                <div className="flex-1 flex flex-col justify-between py-1">
                                    <div>
                                        ...
                                        {item.selectedSize && (
                                            <div className="mt-1">
                                                <span className="inline-flex items-center gap-1 text-[9px] font-bold uppercase tracking-widest bg-[#6d1616]/8 text-[#6d1616] border border-[#6d1616]/20 px-2 py-0.5 rounded-sm">
